...
class TwitterHelper {
	...
	function __construct($username) {
		...
		$this->settings = array(
			'oauth_access_token' => $camden_opt['twitter_mod_oauth_access_token'],
            'oauth_access_token_secret' => $camden_opt['twitter_mod_oauth_access_token_secret'],
            'consumer_key' => $camden_opt['twitter_mod_consumer_key'],
            'consumer_secret' => $camden_opt['twitter_mod_consumer_secret'],
		);
